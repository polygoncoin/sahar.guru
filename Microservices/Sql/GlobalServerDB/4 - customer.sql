...
CREATE TABLE `customer` (
    ...
    `master_db_hostname` VARCHAR(250) NOT NULL,
    `master_db_port` VARCHAR(250) NOT NULL,
    `master_db_username` VARCHAR(250) NOT NULL,
    `master_db_password` VARCHAR(250) NOT NULL,
    `master_db_database` VARCHAR(250) NOT NULL,
    `master_query_placeholder` VARCHAR(250) NOT NULL,
    `slave_db_server_type` VARCHAR(250) NOT NULL,
    `slave_db_hostname` VARCHAR(250) NOT NULL,
    `slave_db_port` VARCHAR(250) NOT NULL,
    `slave_db_username` VARCHAR(250) NOT NULL,
    `slave_db_password` VARCHAR(250) NOT NULL,
    `slave_db_database` VARCHAR(250) NOT NULL,
    `slave_query_placeholder` VARCHAR(250) NOT NULL,
    `usersTable` VARCHAR(250) NOT NULL,
    `master_cache_server_type` VARCHAR(250) NOT NULL,
    `master_cache_hostname` VARCHAR(250) NOT NULL,
    `master_cache_port` VARCHAR(250) NOT NULL,
    `master_cache_username` VARCHAR(250) NOT NULL,
    `master_cache_password` VARCHAR(250) NOT NULL,
    `master_cache_database` VARCHAR(250) NOT NULL,
    `master_cache_table` VARCHAR(250) NOT NULL,
    `slave_cache_server_type` VARCHAR(250) NOT NULL,
    `slave_cache_hostname` VARCHAR(250) NOT NULL,
    `slave_cache_port` VARCHAR(250) NOT NULL,
    `slave_cache_username` VARCHAR(250) NOT NULL,
    `slave_cache_password` VARCHAR(250) NOT NULL,
    `slave_cache_database` VARCHAR(250) NOT NULL,
    `slave_cache_table` VARCHAR(250) NOT NULL,
